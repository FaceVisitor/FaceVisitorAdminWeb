    ...
    children: [
      {
        ...
        name: 'store',
        meta: { title: '내 매장', icon: 'list', affix: true }
      },
      {
        path: 'create',
        component: () => import('@/views/store/create'),
        name: 'StoreCreate',
        meta: { title: 'StoreCreate', noCache: true },
        hidden: true
      },
      {
        path: ':id(\\d+)',
    ...
    children: [
      {
        ...
        name: 'goods',
        meta: { title: '내 상품', icon: 'list', affix: true }
      },
      {
        path: 'create',
        component: () => import('@/views/goods/create'),
        name: 'GoodsCreate',
        meta: { title: 'GoodsCreate', noCache: true },
        hidden: true
      },
      {
        path: ':id(\\d+)',
    ...
    children: [
      {
        ...
        name: 'Order',
        meta: {title: '주문목록', icon: 'list', affix: true}
      },
      {
        path: ':id(\\d+)',
        component: () => import('@/views/order/detail'),
        name: 'OrderList',
        meta: {title: '주문 상세', noCache: true},
        hidden: true
      }
    ]
  },
